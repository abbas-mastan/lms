                                                        ...
                                                        <div class="course-list-img-text">
                                                            ...
                                                            <div class="course-list-text">
                                                                ...
                                                                <div class="course-meta">
                                                                    ...
                                                                    <span
                                                                        class="bold-font">{{ $course->category->name }}</span>
                            ...
                            @else
                                <div class="order-payment">
                                    ...
                                    <div id="accordion">
                                                                ...
                                                                <div class="radio">
                                                                    <label>
                                                                        <input data-toggle="collapse"
                                                                            href="#collapsePaymentOne" type="radio"
                                                                            name="paymentMethod" value="1" checked>
                                                    ...
                                                    <form accept-charset="UTF-8"
                                                        ...
                                                        <div class="payment-info input-2">
                                                            ...
                                                            <input type="text" class="form-control card-cvc required"
                                                                placeholder="@lang('labels.frontend.cart.cvv')" value="">
                                                        </div>
                                                        <div class="payment-info input-2">
                                                            ...
                                                            <input autocomplete='off' type="text"
                                                                ...
                                                                placeholder="@lang('labels.frontend.cart.mm')" value="">
                                                            <input autocomplete='off' type="text"
                                                                class="form-control required card-expiry-year"
                                                                placeholder="@lang('labels.frontend.cart.yy')" value="">
                                                        </div>
                                                        <button type="submit"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="method-header-text">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input data-toggle="collapse"
                                                                            href="#collapsePaymentTwo" type="radio"
                                        ...
                                        @endif
                                        @if (config('services.flutter.active') == 1)
                                            <div class="payment-method w-100 mb-0">
                                                <div class="payment-method-header">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                                ...
                                                                <div class="radio">
                                                                    <label>
                                                                        <input data-toggle="collapse"
                                                                            ...
                                                                            name="paymentMethod" value="8">
                                                                        @lang('labels.frontend.cart.flutter') Wave
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <form class="w3-container w3-display-middle w3-card-4 " method="POST"
                                                        ...
                                                        <div class="payment-info">
                                                            ...
                                                            <input type="text" autocomplete='off' class="form-control"
                                                                name="name" placeholder="@lang('labels.frontend.cart.user_name')"
                                                        ...
                                                        <div class="payment-info">
                                                            <label class=" control-label">@lang('labels.frontend.cart.user_email')
                                                                :</label>
                                                            <input type="text" autocomplete='off' class="form-control"
                                                                name="email" placeholder="@lang('labels.frontend.cart.user_email')"
                                                        ...
                                                        <div class="payment-info">
                                                            <label class=" control-label">@lang('labels.frontend.cart.user_phone')
                                                                :</label>
                                                            <input type="text" autocomplete='off' class="form-control"
                                                                name="phone" placeholder="@lang('labels.frontend.cart.user_phone')"
                                                                value="" required>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="method-header-text">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input data-toggle="collapse"
                                                                            href="#collapsePaymentFour" type="radio"
                                                    ...
                                                    <form class="w3-container w3-display-middle w3-card-4 " method="POST"
                                                        ...
                                                        <div class="payment-info">
                                                            <label class=" control-label">@lang('labels.frontend.cart.user_name')
                                                                :</label>
                                                            <input type="text" autocomplete='off' class="form-control"
                                                                name="user_name" placeholder="@lang('labels.frontend.cart.user_name')"
                                                                value="{{ auth()->user()->name }}" required>
                                                        </div>
                                                        <div class="payment-info">
                                                            <label class=" control-label">@lang('labels.frontend.cart.user_email')
                                                                :</label>
                                                            <input type="text" autocomplete='off' class="form-control"
                                                                name="user_email" placeholder="@lang('labels.frontend.cart.user_email')"
                                                                value="{{ auth()->user()->email }}" required>
                                                        </div>
                                                        <div class="payment-info">
                                                            <label class=" control-label">@lang('labels.frontend.cart.user_phone')
                                                                :</label>
                                                            <input type="text" autocomplete='off' class="form-control"
                                                                name="user_phone" placeholder="@lang('labels.frontend.cart.user_phone')"
                                                                value="" required>
                                                        </div>
                                                        <button type="submit"
                                                            class="text-white genius-btn mt25 gradient-bg text-center text-uppercase  bold-font">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="method-header-text">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input data-toggle="collapse"
                                                                            href="#collapsePaymentFive" type="radio"
                                                                            name="paymentMethod" value="5">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="method-header-text">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input data-toggle="collapse"
                                                                            href="#collapsePaymentSix" type="radio"
                                                                            name="paymentMethod" value="6">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="method-header-text">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input data-toggle="collapse"
                                                                            href="#collapsePaymentPayU" type="radio"
                                                                            name="paymentMethod" value="5">
